...
public class BotRegistry {
    ...
    static {
        ...
        bots.add(new BotDescriptor("output_buffer_zone", BotDescriptor.BotType.UTILS, "Free Containers in Output Buffer Zone", "Automatically navigates to an output buffer zone and redistributes its containers/stockpiles to the areas actually meant for them (never to another buffer zone).", true, true, FreeContainersInOutputBufferZone.class, "output_buffer_zone", false));
